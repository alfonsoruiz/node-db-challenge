...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  Relational Databases are where we store data and SQL is the language we use to Query and insert data into a database.

- [ ] Why do tables need a `primary key`?

  Primary keys are needed to uniquely identify records/rows within a table.
...
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  ...
  A third table to manage the relationship between the two.
